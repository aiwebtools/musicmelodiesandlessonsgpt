      ...
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-6">
          <a 
            ...
            className="relative group px-4 py-2 rounded-lg font-rajdhani font-bold text-sm overflow-hidden transition-all duration-300 border-2 border-cyberpunk-primary/50 bg-cyberpunk-primary/10 hover:border-cyberpunk-primary hover:bg-cyberpunk-primary/20 hover:scale-105"
          >
            ...
            <span className="relative z-10 neon-text font-rajdhani">Music Melodies GPT</span>
        ...
        <div className="md:hidden absolute top-full left-0 right-0 bg-cyberpunk-background/95 backdrop-blur-lg border-b border-white/10 py-4">
          <nav className="container mx-auto px-4 flex flex-col space-y-4">
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="relative group px-4 py-3 rounded-lg font-rajdhani font-bold text-sm overflow-hidden transition-all duration-300 border-2 border-cyberpunk-primary/50 bg-cyberpunk-primary/10 hover:border-cyberpunk-primary hover:bg-cyberpunk-primary/20 hover:scale-105 w-full text-center"
